...
(function (_w, _d) {
    ...
    for (var i = 0; i < scs.length; i++)if (scs[i].src.indexOf("/404/search_children.js") > -1) {
    ...
    function getData(srcUrl, callback) {
        ...
        function orc() {
            if (sc.readyState === "loaded")setTimeout(function () {
                callback &&
                callback()
            }, 0)
        }
        ...
        if (sc.addEventListener) {
            if (callback)sc.addEventListener("load", callback, false)
        } else sc.attachEvent("onreadystatechange", orc);
        ...
        if ("object" == typeof d && (d.data && (len = d.data.length))) {
            for (var i = 0; i < len; i++) {
                ...
                if (expire && tmnow * 1E3 < Date.parse(expire.replace(/\s[\s\S]*$/, "").replace(/\-/g, "/"))) {
                    ...
                    if (_c && city)if (("_" + _c + "_").indexOf("_" + city + "_") > -1) {
                        ddata.push(d.data[i]);
                        continue
                    }
                    if (_p && province)if (("_" + _p + "_").indexOf("_" + province + "_") > -1)ddata.push(d.data[i])
                }
            }
            ...
            if (_w.foundjsondata) {
                ...
                tdata.name = "\u201c7\u00b718\u7279\u5927\u62d0\u5356\u5a74\u513f\u6848\u201d\u544a\u7834\uff0c\u88ab\u89e3\u6551\u768415\u540d\u5b69\u5b50\u4e2d\uff0c2\u4eba\u7531\u4eb2\u751f\u7236\u6bcd\u9886\u56de\uff0c\u4ecd\u670913\u540d\u5b69\u5b50\u672a\u627e\u5230\u4eb2\u751f\u7236\u6bcd\uff0c\u88ab\u5b89\u7f6e\u5728\u60e0\u5dde\u5e02\u793e\u4f1a\u798f\u5229\u9662\uff0c" +
                    tdata.ta + "\u662f\u5176\u4e2d\u4e4b\u4e00\u3002";
            ...
            if (!tdata.ext1)tdata.ext1 = "\u4f46\u6211\u4eec\u53ef\u4ee5\u4e00\u8d77\u5bfb\u627e\u5931\u8e2a\u5b9d\u8d1d";
            return tdata
        }
    }
    ...
    _w.share = function (target) {
        ...
        if (summary)summary = "#\u5bfb\u627e\u5931\u8e2a\u7684\u5b9d\u8d1d#" + summary;
        var stitle = "\u5931\u8e2a\u7684\u5b9d\u8d1d\u8be6\u60c5";
        ...
        var surl = opts.surl || "http://www.qq.com/404/", summary = opts.summary || "\u8fd9\u4e2a\u662f\u5206\u4eab\u7684\u5185\u5bb9",
            stitle = opts.stitle || "\u8fd9\u4e2a\u662f\u5206\u4eab\u7684\u6807\u9898", pics = opts.pics || "http://qzonestyle.gtimg.cn/qzone_v6/act/img/20120422_qzone_7_years/pop_up/icon-pop-seven-years.png", site = opts.site || "\u8fd9\u4e2a\u662f\u5206\u4eab\u94fe\u63a5\u7684\u6587\u5b57", desc = opts.desc || "\u5931\u8e2a\u7684\u5b9d\u8d1d\u8981\u56de\u5bb6\uff0c\u5feb\u6765\u53c2\u4e0e\u7231\u5fc3\u7684\u4f20\u9012\u5427\uff01", origin_url = opts.origin_url || "http://www.qq.com/404/";
        var shareList = {
            weibo: {
                method: function (evt) {
                    var w =
                        "http://v.t.qq.com/share/share.php", q = ["?site=", encode(surl + "#via=share_t_weib"), "&title=", encode(summary), "&pic=", encode(pics), "&url=", encode(surl)].join(""), p = [w, q].join("");
                ...
                method: function (evt) {
                    ...
                    for (var k in ps)buff.push(k + "=" + encode(ps[k] || ""));
                ...
                method: function () {
                    var w = "http://v.t.sina.com.cn/share/share.php",
                        q = ["?url=", encode(surl + "#via=share_x_weib"), "&title=", encode(summary), "&source=", "&sourceUrl=", surl, "&content=utf-8", "&pic=", encode(pics)].join(""), p = [w, q].join("");
                ...
                method: function () {
                    var n = "http://www.connect.renren.com/share/sharer?title=" +
                        encode(summary) + "&url=" + encode(surl + "#via=share_renren"), p = window.open(n, "rr", "toolbar=0,status=0,resizable=1,width=510,height=300");
                    if (p)p.focus()
                }
            }, weixin: {
                method: function () {
        ...
        var openit = function (u, n, p) {
            function o() {
                var z;
                if (!(z = window.open(u, n, p)))location.href = u; else z.focus()
            }
    ...
    _w.toThis = function (id) {
        for (var i = 0; i < $scope.otherdata.length; i++)if ($scope.otherdata[i]._id == id) {
    ...
    (function initStat() {
        ...
        function cb() {
            ...
            var src = "";
            if (qzoneDomainNameRE.test(url))src = "new404.qzone"; else if (qqDomainNameRE.test(url))src = "new404.qq"; else if (qzsDomainNameRE.test(url))src = "new404.qzonestyle"; else src = url.replace(".", "_");
            _w.TCISD && (_w.TCISD.pv && _w.TCISD.pv("hat.qzone.qq.com", "/gy/lostchild/" + src))
        }

        getData("http://qzonestyle.gtimg.cn/ac/qzfl/stat.js",
            cb)
    })()
})(window, document);
!function () {
