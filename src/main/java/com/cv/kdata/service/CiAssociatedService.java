...
import com.cv.kdata.dao.CiChnFilmBoxMapper;
import com.cv.kdata.dao.CiCorePayShareMapper;
import com.cv.kdata.dao.CiCptocScaMapper;
import com.cv.kdata.dao.CiDtourIncomeMapper;
import com.cv.kdata.dao.CiOlVideoIncmMapper;
...
import com.cv.kdata.model.ci.CiAbvLimCrs;
import com.cv.kdata.model.ci.CiAddRmbLoan;
import com.cv.kdata.model.ci.CiAgriculturalOutput;
import com.cv.kdata.model.ci.CiAirCleanerSales;
import com.cv.kdata.model.ci.CiAutomatSalInv;
import com.cv.kdata.model.ci.CiBcAvgAmo;
import com.cv.kdata.model.ci.CiBitPrice;
import com.cv.kdata.model.ci.CiCbEcSca;
import com.cv.kdata.model.ci.CiCcIndex;
import com.cv.kdata.model.ci.CiCcNum;
import com.cv.kdata.model.ci.CiCeVecSales;
import com.cv.kdata.model.ci.CiChnFilmStat;
import com.cv.kdata.model.ci.CiChnNetizenNet;
import com.cv.kdata.model.ci.CiChsArea;
import com.cv.kdata.model.ci.CiCoScPropt;
import com.cv.kdata.model.ci.CiCourierBizSrvy;
import com.cv.kdata.model.ci.CiCsOrgFundSca;
import com.cv.kdata.model.ci.CiDmpDeli;
import com.cv.kdata.model.ci.CiEightRRRValue;
import com.cv.kdata.model.ci.CiEngelCoefficient;
import com.cv.kdata.model.ci.CiEntDayStat;
import com.cv.kdata.model.ci.CiEntMonStat;
import com.cv.kdata.model.ci.CiFreVolGrowth;
import com.cv.kdata.model.ci.CiGdp;
import com.cv.kdata.model.ci.CiGeneCoefficient;
import com.cv.kdata.model.ci.CiHotAppUse;
import com.cv.kdata.model.ci.CiHsConsuLoan;
import com.cv.kdata.model.ci.CiHunderdCareerSd;
import com.cv.kdata.model.ci.CiIndHoursLoan;
import com.cv.kdata.model.ci.CiJpnRetail;
import com.cv.kdata.model.ci.CiLcGdp;
import com.cv.kdata.model.ci.CiLusConsuSca;
import com.cv.kdata.model.ci.CiManufPmi;
import com.cv.kdata.model.ci.CiMbShopSca;
import com.cv.kdata.model.ci.CiMiaData;
import com.cv.kdata.model.ci.CiMigrantWorkerInc;
import com.cv.kdata.model.ci.CiMigrantWorkerSca;
import com.cv.kdata.model.ci.CiMoneySup;
import com.cv.kdata.model.ci.CiNetScy;
import com.cv.kdata.model.ci.CiNewEmpPopulation;
import com.cv.kdata.model.ci.CiNhreConsmpSpeed;
import com.cv.kdata.model.ci.CiNonManufPmi;
import com.cv.kdata.model.ci.CiNsFundSca;
import com.cv.kdata.model.ci.CiOlGameIncm;
import com.cv.kdata.model.ci.CiOlShopPr;
import com.cv.kdata.model.ci.CiOlgIncomComp;
import com.cv.kdata.model.ci.CiOlgIncomSac;
import com.cv.kdata.model.ci.CiOlgUserSca;
import com.cv.kdata.model.ci.CiOlgVideoIncm;
import com.cv.kdata.model.ci.CiOpsStatInstResearch;
import com.cv.kdata.model.ci.CiOpsStatToeMa;
import com.cv.kdata.model.ci.CiOrScPropt;
import com.cv.kdata.model.ci.CiPayRank;
import com.cv.kdata.model.ci.CiPaymComp;
import com.cv.kdata.model.ci.CiPaymSca;
import com.cv.kdata.model.ci.CiPhoneOlShop;
import com.cv.kdata.model.ci.CiPltDistribution;
import com.cv.kdata.model.ci.CiPltGrowth;
import com.cv.kdata.model.ci.CiPopulationSca;
import com.cv.kdata.model.ci.CiPtopNlSca;
import com.cv.kdata.model.ci.CiRcaPay;
import com.cv.kdata.model.ci.CiRegUnempRate;
import com.cv.kdata.model.ci.CiRhfsArea;
import com.cv.kdata.model.ci.CiRifaAmount;
import com.cv.kdata.model.ci.CiSfSca;
import com.cv.kdata.model.ci.CiShtRentSca;
import com.cv.kdata.model.ci.CiSocialInsurance;
import com.cv.kdata.model.ci.CiSpSales;
import com.cv.kdata.model.ci.CiTifaAmout;
import com.cv.kdata.model.ci.CiTotSocialLog;
import com.cv.kdata.model.ci.CiTpFundDisc;
import com.cv.kdata.model.ci.CiTslcAcctGdp;
import com.cv.kdata.model.ci.CiUrPcce;
import com.cv.kdata.model.ci.CiUrResdIncome;
import com.cv.kdata.model.ci.CiUrcSca;
import com.cv.kdata.model.ci.CiUsConsuGrowth;
import com.cv.kdata.model.ci.CiUsCr;
import com.cv.kdata.model.ci.CiUsNetRetail;
import com.cv.kdata.model.ci.CiUsNewEmployee;
import com.cv.kdata.model.ci.CiUsNpRetail;
import com.cv.kdata.model.ci.CiUsPsce;
import com.cv.kdata.model.ci.CiUsedCarSales;
import com.cv.kdata.model.ci.CiWorldOsShare;
import com.cv.kdata.model.ci.CiWtClnSales;
