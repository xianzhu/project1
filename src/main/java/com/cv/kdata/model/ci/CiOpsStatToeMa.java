...
public class CiOpsStatToeMa {
    ...
    private Integer buyerStockNum;

    private Integer buyerStockRate;
    ...
    private Integer ownerStockNum;

    private Integer ownerStockRate;
    ...
    public Integer getBuyerStockNum() {
        return buyerStockNum;
    }

    public void setBuyerStockNum(Integer buyerStockNum) {
        this.buyerStockNum = buyerStockNum;
    }

    public Integer getBuyerStockRate() {
        return buyerStockRate;
    }

    public void setBuyerStockRate(Integer buyerStockRate) {
    ...
    public Integer getOwnerStockNum() {
        return ownerStockNum;
    }

    public void setOwnerStockNum(Integer ownerStockNum) {
        this.ownerStockNum = ownerStockNum;
    }

    public Integer getOwnerStockRate() {
        return ownerStockRate;
    }

    public void setOwnerStockRate(Integer ownerStockRate) {
