...
public class CiOlVideoIncm implements Serializable{
    /**
	 * 
	 */
	...
	public String toString() {
		return "CiOlVideoIncm [id=" + id + ", statDate=" + statDate + ", olvQuarterValue=" + olvQuarterValue
				+ ", olvUpQuarter=" + olvUpQuarter + ", olvRgQuarter=" + olvRgQuarter + ", olaQuarterValue="
				+ olaQuarterValue + ", olaUpQuarter=" + olaUpQuarter + ", olaRgQuarter=" + olaRgQuarter + "]";
	}
