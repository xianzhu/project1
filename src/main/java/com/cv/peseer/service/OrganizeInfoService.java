...
import com.cv.peseer.dao.CategoryTableMapper;
...
import com.cv.peseer.dao.PMOrgExtendEntityMapper;
import com.cv.peseer.dao.PMOrgInfoMapper;
import com.cv.peseer.dao.PMStartupInfoMapper;
import com.cv.peseer.dao.PMUserInfoMapper;
import com.cv.peseer.dao.RptOrgForcusEntMapper;
import com.cv.peseer.dao.RptOrgOverallTrendsMapper;
import com.cv.peseer.dao.RptPeFundMapper;
...
import com.cv.peseer.response.OrganizeResponse;
...
public class OrganizeInfoService {
	...
	public void getRptPeList(HttpServletRequest req, OrganizeResponse response) {
		...
		if (list != null && !list.isEmpty()) {
			...
			response.setRptPeFundList(list);
			return;
		}
