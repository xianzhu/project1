...
import com.cv.peseer.response.XsbListMatchingResponse;
import com.cv.peseer.service.CiAssociatedService;
import com.cv.peseer.service.ToolsPlatformService;
import com.cv.peseer.service.UserInfoCustService;
import com.cv.peseer.service.XsbListMatchingService;
...
public class ToolsPlatformController {
	...
	public CiAssociatedResponse ciAssociatedInfo(HttpServletRequest request, Model model) {
		...
		if(StringUtil.isNullOrEmpty(type)){
			basicResponse.setStatus(com.cv.peseer.cont.RDDWebConst.FAILURE);
