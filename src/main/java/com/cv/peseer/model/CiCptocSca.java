...
public class CiCptocSca implements Serializable{
    /**
	 * 
	 */
	...
	public String toString() {
		return "CiCptocSca [id=" + id + ", statDate=" + statDate + ", dealYearValue=" + dealYearValue
				+ ", dealGrowthRate=" + dealGrowthRate + ", entYearValue=" + entYearValue + ", entGrowthRate="
				+ entGrowthRate + ", chnYearValue=" + chnYearValue + ", chnGrowthRate=" + chnGrowthRate + "]";
	}
