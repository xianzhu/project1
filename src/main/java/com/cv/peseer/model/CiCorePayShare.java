...
public class CiCorePayShare implements Serializable{
    /**
	 * 
	 */
	...
	public String toString() {
		return "CiCorePayShare [id=" + id + ", statDate=" + statDate + ", zfb=" + zfb + ", cft=" + cft + ", ylzx="
				+ ylzx + ", kq=" + kq + ", hftx=" + hftx + ", ybzf=" + ybzf + ", hxzf=" + hxzf + ", others=" + others
				+ "]";
	}
