...
public abstract class BasePmInvestEventDetail<M extends BasePmInvestEventDetail<M>> extends Model<M> implements IBean {

	/**
	 * 表名
	 */
	public static final String TableName = "pm_invest_event_detail";
